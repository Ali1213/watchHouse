...
windows.channel_key = '005AAAoADU2QzU4RjVDMjhEODI3MkRGODNDREFCODUzMDU0OTMxMDU0N0YxRDQQAGLVvw1Dh01bnyxHq8O1N5ry8jZboyQmAAAAAAAAAA==';
windows.channelValue = 110;
...
function join() {
  ...
  client.on('error', function (err) {
    ...
    if (err.reason === 'DYNAMIC_KEY_TIMEOUT') {
      client.renewChannelKey(channel_key, function () {
