...
window.channelKey = '005AAAoADU2QzU4RjVDMjhEODI3MkRGODNDREFCODUzMDU0OTMxMDU0N0YxRDQQAGLVvw1Dh01bnyxHq8O1N5ry8jZboyQmAAAAAAAAAA==';
window.channelValue = '1000';
...
function join() {
  ...
  var appId = '9b2179c0cba0431bb9899853ae87d3e7';
  console.log('========', AGORA_APP_ID);
  console.log("Init AgoraRTC client with vendor key: " + appId);
  client = AgoraRTC.createClient({ mode: 'interop' });
  client.init(appId, function () {
    console.log("AgoraRTC client initialized");
    client.join(channelKey, channelValue, null, function (uid) {
      console.log("User " + uid + " join channel successfully");
